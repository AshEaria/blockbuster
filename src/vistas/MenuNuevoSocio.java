 ...
 *
 */
public class MenuNuevoSocio extends JPanel {
	...
	public MenuNuevoSocio() {
		

		/* PANTALLA PRINCIPAL*/
		
		/*Crear componentes*/
		JLabel Ltitulo = new JLabel("Nuevo Socio"); 
		...
		socio.setLayout(new BoxLayout(socio, BoxLayout.Y_AXIS));
