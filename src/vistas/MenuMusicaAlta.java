 ...
 * 
 */
public class MenuMusicaAlta extends JPanel {
	...
	private JTextField Tinterprete;
	...
	public MenuMusicaAlta() {

		/* PANTALLA PRINCIPAL */

		/* Crear componentes */
		JLabel Ltitulo = new JLabel("Dar alta musica");
		...
		JLabel Linterprete = new JLabel("Interprete:");
		...
		vinilo = new JRadioButton("vinilo");
		...
		/* Categoria */
		ArrayList<Categoria>  ListaCategorias= Catalogo.getInstance().getCategoriasMusica();
		...
		aceptar.setActionCommand("modoMusicaAlta");
	...
	public JRadioButton getCajaCD() {
		return CD;
	}

	public JRadioButton getCajaVinilo() {
		return vinilo;
	}
