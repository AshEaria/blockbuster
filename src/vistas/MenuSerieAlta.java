 ...
 * 
 */
public class MenuSerieAlta extends JPanel {
	...
	private JComboBox<?> Ttemporada;
	private JTextField Tvolumen;
	private JCheckBox[] Tcategoria;
	//private JTextField NuevaCat;

	@SuppressWarnings({ "unchecked", "rawtypes" })
	public MenuSerieAlta() {

		/* PANTALLA PRINCIPAL */

		/* Crear componentes */
		JLabel Ltitulo = new JLabel("Dar alta serie");
		JLabel LTitulo = new JLabel("Titulo:");
		LTitulo.setBorder(BorderFactory.createEmptyBorder(1, 1, 25, 40));
		JLabel Ltemporada = new JLabel("Temporada:");
		Ltemporada.setBorder(BorderFactory.createEmptyBorder(1, 1, 25, 40));
		JLabel Lvolumen = new JLabel("Volumen:");
		Lvolumen.setBorder(BorderFactory.createEmptyBorder(1, 1, 25, 40));
		...
		/* Temporada */
		Ttemporada = new JComboBox(ano);

		/* Interprete */
		Tvolumen = new JTextField();
		/* Categoria */
		ArrayList<Categoria>  ListaCategorias= Catalogo.getInstance().getCategoriasSerie();
		...
		aceptar.setActionCommand("modoSerieAlta");
		...
		PTinterprete
				.setLayout(new BoxLayout(PTinterprete, BoxLayout.LINE_AXIS));
		...
		Patras.setBorder(BorderFactory.createEmptyBorder(100, 0, 0, 48));
		...
		PTfecha.add(Ttemporada);
		PTinterprete.add(Tvolumen);
		...
		columna1.add(Ltemporada);
		columna1.add(Lvolumen);
	...
	public JComboBox<?> getCajaTemporada() {
		return Ttemporada;
	}

	public JTextField getCajaVolumen() {
		return Tvolumen;
	}
