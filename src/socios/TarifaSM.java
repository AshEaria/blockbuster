...
/**
 * Esta clase representa el tipo de tarifa combinada Serie + Musica. 
 * 
 * @author Jaime Monedero y Elena Lechuga
 */
public class TarifaSM extends Tarifa {
	 ...
	 */
	public TarifaSM(Socio socio, boolean plus) {
		super(socio, plus);
	}
	 ...
	 * @param plus Define si la tarifa es plus (dia(s) extra de alquiler) o no
	 */
	public TarifaSM(int idTarifa, int socio, Calendar fechaInicio, Calendar fechaFin, boolean plus) {
		super(idTarifa, socio, fechaInicio, fechaFin, plus);
	}
	
	@Override
	public String toString() {
		return "TSM,"+ getId() +","+ getSocio().getNumSocio() + "," +  getFechaInicio().get(Calendar.DAY_OF_MONTH)+"."+(getFechaInicio().get(Calendar.MONTH)+1)+"."+getFechaInicio().get(Calendar.YEAR)+ "," 
