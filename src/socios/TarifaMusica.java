...
/**
 * Esta clase representa el tipo de tarifa sencilla Musica. 
 * 
 * @author Jaime Monedero y Elena Lechuga
 */
public class TarifaMusica extends Tarifa{
	 ...
	 */
	public TarifaMusica(Socio socio, boolean plus) {
		super(socio, plus);
	}
	 ...
	 * @param plus Define si la tarifa es plus (dia(s) extra de alquiler) o no
	 */
	public TarifaMusica(int idTarifa, int socio, Calendar fechaInicio, Calendar fechaFin, boolean plus) {
	...
	public String toString() {
		return "TM,"+ getId() +","+ getSocio().getNumSocio() + "," + getFechaInicio().get(Calendar.DAY_OF_MONTH)+"."+(getFechaInicio().get(Calendar.MONTH)+1)+"."+getFechaInicio().get(Calendar.YEAR)+ "," 
