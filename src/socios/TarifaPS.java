 ...
 */
public class TarifaPS extends Tarifa {
...
/* CONSTRUCTORES */
	 ...
	 */
	public TarifaPS(Socio socio, boolean plus) {
		super(socio, plus);
	}
	 ...
	 * @param plus Define si la tarifa es plus (dia(s) extra de alquiler) o no
	 */
	public TarifaPS(int idTarifa, int socio, Calendar fechaInicio, Calendar fechaFin, boolean plus) {
		super(idTarifa, socio, fechaInicio, fechaFin, plus);
	}
	
	@Override
	public String toString() {
		return "TPS,"+ getId()+","+ getSocio().getNumSocio() +","+ getFechaInicio().get(Calendar.DAY_OF_MONTH)+"."+(getFechaInicio().get(Calendar.MONTH)+1)+"."+getFechaInicio().get(Calendar.YEAR)+ "," 
