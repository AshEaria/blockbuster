...
/**
 * Esta clase representa el tipo de tarifa Premium. 
 * 
 * @author Jaime Monedero y Elena Lechuga
 */
public class TarifaPremium extends Tarifa {
	 ...
	 */
	public TarifaPremium(Socio socio, boolean plus) {
		super(socio, plus);
	}
	 ...
	 * @param plus Define si la tarifa es plus (dia(s) extra de alquiler) o no
	 */
	public TarifaPremium(int idTarifa, int socio, Calendar fechaInicio, Calendar fechaFin, boolean plus) {
